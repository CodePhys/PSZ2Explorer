...
| 2 | `ra` | — | Ascensione retta (gradi) |
| 3 | `dec` | — | Declinazione (gradi) |
...
- **Colonne lette:** `name`, `redshift`, `mass_sz`, `snr`, `y5r500`, `validation_status`, `cosmology_sample_flag`.
...
Puoi scrivere ad esempio: *«I dati sono stati letti dal catalogo PSZ2 in formato CSV (colonne: name, redshift, mass_sz, snr, y5r500, validation_status, cosmology_sample_flag). Il parametro y₅R₅₀₀ è adimensionale (ordine 10⁻³–10⁻²); la massa M₅₀₀^SZ è in unità di 10¹⁴ M⊙.»*
